...
public class GaneshChaturthiOutfits extends Application {

    private final int TOTAL_IMAGES = 12;

    @Override
    public void start(Stage stage) {
        // Fullscreen size using screen bounds
        Rectangle2D screenBounds = Screen.getPrimary().getVisualBounds();
        stage.setX(screenBounds.getMinX());
        stage.setY(screenBounds.getMinY());
        stage.setWidth(screenBounds.getWidth());
        stage.setHeight(screenBounds.getHeight());
        stage.setTitle("Ganesh Chaturthi Outfits");
    ...
    public Scene getScene(Stage stage) {
        ...
        Text subtitle = new Text("Ganesh Chaturthi Outfits");
        ...
        for (int i = 1; i <= TOTAL_IMAGES; i++) {
            ...
            String imgName = "Ganpati" + i;
            Image image = null;

            try {
                image = new Image(getClass().getResource("/assets/Images/Ganpati/" + imgName + ".jpg").toExternalForm());
            } catch (Exception ex) {
                try {
                    image = new Image(getClass().getResource("/assets/Images/Ganpati/" + imgName + ".png").toExternalForm());
            ...
            viewButton.setOnAction(e -> {
                GaneshViewOutfitPage viewPage = new GaneshViewOutfitPage();
                stage.setScene(viewPage.getScene(stage, imgName));
            });
        ...
        transparentBox.setMaxWidth(1400);
